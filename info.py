...
#main variables
API_ID = int(environ.get('API_ID', '23205028'))
API_HASH = environ.get('API_HASH', 'd643430b289378849c13f2bdccb2de55')
BOT_TOKEN = environ.get('BOT_TOKEN', '7631833696:AAEom3Yv8pvcVdQWmepsuT_O6UQqjPqtvTo')

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6804892450').split()]
USERNAME = environ.get('USERNAME', "https://telegram.me/biisal")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002269779743'))
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002305418437'))
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002498504949'))
...
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '--1002403080130'))
